            ...
            <div className="max-w-6xl mx-auto px-4">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <a href="https://guilhermercarvalho.github.io/blog/posts/" className="text-gray-700 hover:text-blue-500">{t('navigation.blog')}</a>
                    </div>
            ...
            {isOpen && (
                <div className="md:hidden">
                    <div className="px-2 pt-2 pb-3 space-y-1 bg-white">
                        ...
                        <a
                            href="https://guilhermercarvalho.github.io/blog/posts/"
                            className="block px-3 py-2 text-gray-700 hover:text-blue-500"
                            onClick={() => setIsOpen(false)}
                        >
                            {t('navigation.blog')}
